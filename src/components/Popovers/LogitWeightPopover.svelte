<script lang="ts">
	...
	// color scale
	const embeddingColorScale = (t: number): string => {
		return d3.interpolate(theme.colors['blue'][100], theme.colors['blue'][400])(t);
	};
	const weightColorScale = (t: number): string => {
		return d3.interpolate(theme.colors['gray'][100], theme.colors['gray'][400])(t);
	};
	const logitColorScale = (t: number): string => {
		return d3.interpolate(theme.colors['blue'][100], theme.colors['gray'][400])(t);
	};
	...
	// No-op handlers for Matrix components that don't need interactions
	...
	<div class="weight-popover-content flex items-center justify-start">
		<div class="matrix flex flex-col items-center">
			...
			<Matrix
				...
				{highlightRow}
				onMouseOverCell={noOpMouseHandler}
				onMouseOutCell={noOpMouseHandler}
				onMouseOutSvg={noOpMouseHandler}
				showTooltip={noOpTooltipHandler}
				highlightCol={undefined}
			/>
