<script lang="ts">
	...
	export const offset: PopoverProps['offset'] = undefined;
	export const className: PopoverProps['class'] = undefined;
	export const triggeredBy: PopoverProps['triggeredBy'] = undefined;
	export const trigger: PopoverProps['trigger'] = 'hover';
	export const placement: PopoverProps['placement'] = 'right';
	export const open: PopoverProps['open'] = false;
...
<div class="popover-container emb_pos">
	...
	<div class="content">
		<div class="token-container">
			...
			<div class="positions">
				<div class="subtitle">Kedudukan</div>
				<div class="subcontent flex flex-col">
					{#each $tokens as token, token_idx}
						<div
							class="position-box"
			...
			<div class="embs">
				<div class="subtitle">Pembenaman</div>
				<div class="subcontent flex flex-col">
					{#each $tokens as token, token_idx}
						<div
		...
		<div class="viz-container">
			<div class="subtitle">Matriks Pengekodan</div>
				...
				<div class="formula-container mt-4 w-[400] flex-col justify-around gap-1 bg-gray-50 p-2">
					<div class="even-pos flex h-10 flex-1 items-center justify-between gap-4 p-1">
						<div class="flex items-center justify-center gap-1">
							...
							{#if $hoveredCol !== null && $hoveredCol % 2 === 0}
							...
							{:else}
								<span class="flex w-8 justify-center rounded-sm border border-blue-400">-</span>
							{/if}
							<span>(</span>
