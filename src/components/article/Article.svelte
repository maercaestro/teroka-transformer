...
<div id="description">
	...
	<div class="article-section" id="embedding" data-click="article-embedding">
		...
		<div class="figure">
			<img src="./article_assets/embedding.png" width="65%" alt="Embedding layer diagram showing tokenization, token embedding, positional encoding, and final embedding steps" />
		</div>
	...
	<div class="article-section" id="self-attention" data-click="article-attention">
		...
		<div class="article-subsection-l2">
			...
			<div class="figure pt-10">
				<img src="./article_assets/QKV.png" width="80%" alt="Query, Key, and Value matrices generation from embeddings" />
				<div class="text-xs">
					<Katex
						displayMode
						math={`
		...
		<div class="article-subsection-l2">
			...
			<div class="figure">
				<img src="./article_assets/attention.png" width="80%" alt="Attention mechanism diagram showing Query-Key dot product and softmax calculation" style="vertical-align: middle;" />
			</div>
			<div class="figure-caption">
	...
	<div class="article-section" id="article-activation" data-click="article-mlp">
		...
		<div class="figure">
			<img src="./article_assets/mlp.png" width="70%" alt="MLP layer diagram showing projection to higher dimensions and back" style="vertical-align: middle;" />
		</div>
		<div class="figure-caption">
	...
	<div class="article-section" id="article-prob" data-click="article-prob">
		...
		<div class="figure py-5">
			<img src="./article_assets/softmax.png" width="70%" alt="Softmax function converting logits to probability distribution over vocabulary" />
		</div>
		<div class="figure-caption">
	...
	<div class="article-section" data-click="article-video">
		...
		<div class="video-container">
			<iframe
				...
				title="Transformer Explainer Video Tutorial"
				frameborder="0"
